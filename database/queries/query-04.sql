...
VALUES
	(@JohnDoeUserId, 1, 'John Doe', 78, 'john@doe.com', '0123123230924', '0123452789'),
	(@JohnDoeSegundoUserId, 1, 'John Doe', 78, 'john2@doe.com', '0123123230925', '0123456689'),
	(@JohnDoeTerceroUserId, 1, 'John Doe', 78, 'john1@doe.com', '0123123230926', '0123426779');

INSERT INTO Usuarios (TipoId, Nombre, Edad, Correo, NumeroDeTelefono, Cedula)
VALUES
	(1, 'John Doe', 78, 'john4@doe.com', '0143123230923', '0126457789');
